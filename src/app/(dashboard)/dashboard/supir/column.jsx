    ...
    try {
      ...
      if (response.ok) {
        ...
        Swal.fire({
          ...
          text: "Pastikan data sopir tidak memiliki relasi dengan data lain",
          icon: "error",
          confirmButtonText: "OK",
        });
      }
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuSeparator />
        <Link href={`/dashboard/supir/${data.supir_id}/edit`}>
          ...
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction
                ...
                onClick={() => handleDelete(data.supir_id)}
              >
                Hapus Data
              </AlertDialogAction>
            </AlertDialogFooter>
...
export const columns = [
  ...
  {
    accessorKey: "jumlah_antaran",
    header: "Jumlah Antaran",
  },
  {
    id: "actions",
    header: "Aksi",
